...
let screw = new SCREW({value: 60, unit: UTILS.units.mm})
let stroke = new STROKE({value: 60, unit: UTILS.units.mm}, screw)
let rotation = new ROTATION({value: 191, unit: UTILS.units.rpm}, screw)

//console.log(UTILS.parse_unit_of_value(stroke.get_volume(), UTILS.units.cm3))
//console.log(rotation.get_rotation(UTILS.units.mms));